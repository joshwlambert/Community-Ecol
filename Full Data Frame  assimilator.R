...
for(i in 1:21) {
  nam1 <- paste("Maximum_Likelihood/backup/ML_values_sim_", i, ".RDATA", sep = "")
  nam2 <- paste("simulation_parameters/backup/pars_sim_", i, ".RDATA", sep = "")
  load(nam1)
  load(nam2)
  ...
  if(exists("nonoceanic")) prop_endemic <-rep(nonoceanic[1],100) else prop_endemic <- rep(NA,100)
